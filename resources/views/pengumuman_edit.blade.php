                        ...
                        <div class="berita">
                            ...
                            <div id="konten"><br>
                                <form action="{{ route('pengumuman.update', $pengumuman -> id) }}" method="POST"
                                    ...
                                    <input type="date" value="{{ $pengumuman->tanggal_pengumuman }}" name="tanggal_pengumuman" required>
                                    <h5><strong>Judul Pengumuman</strong></h5>
                                    <input type="text" value="{{ $pengumuman->isi_pengumuman }}" name="isi_pengumuman" required><br>
                                    <h5><strong>Detail Pengumuman</strong></h5>
                                    <textarea rows="10" cols="100" class="span12" value="{{ $pengumuman->detail_pengumuman }}" name="detail_pengumuman" id="editor">{{ $pengumuman -> detail_pengumuman }}</textarea>
